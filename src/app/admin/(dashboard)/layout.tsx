  ...
  return (
    <div className="layout">
      <style>{`
        ...
        .header .user-info a { color: #d63637; text-decoration: none; margin-left: 8px; }
        ...
        .btn-primary:hover { background: #0d4732; }
        .btn-danger { background: #d63637; color: white; }
        .btn-danger:hover { background: #b82d2e; }
        .btn-sm { padding: 4px 10px; font-size: 12px; }
        .btn-outline { background: transparent; border: 1px solid #ddd; color: #333; }
        .btn-outline:hover { background: #f5f5f5; }
        .form-group { margin-bottom: 16px; }
        .form-group label { display: block; margin-bottom: 4px; font-weight: 500; font-size: 14px; color: #333; }
        ...
        .form-group .error { color: #d63637; font-size: 12px; margin-top: 2px; }
        ...
        .search-bar input, .search-bar select { padding: 8px 12px; border: 1px solid #ddd; border-radius: 6px; font-size: 14px; }
        .search-bar input { flex: 1; min-width: 200px; }
        .pagination { display: flex; gap: 4px; justify-content: center; margin-top: 16px; flex-wrap: wrap; }
        .pagination a, .pagination span { padding: 6px 12px; border: 1px solid #ddd; border-radius: 4px; text-decoration: none; font-size: 13px; color: #333; }
        .pagination a:hover { background: #f0f0f0; }
        .pagination .current { background: #11593f; color: white; border-color: #11593f; }
      `}</style>
