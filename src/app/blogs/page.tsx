...
export default function BlogsPage() {
  ...
  return (
    <main className="min-h-screen bg-white m-0 p-0">
      ...
      <section className="w-full py-12 md:py-16 lg:py-24 bg-white min-h-[60vh] flex items-center justify-center">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-6 px-4">
            <div className="text-left hidden md:block mt-25" style={{ fontFamily: '"Quicksand", Sans-serif', fontSize: '1.5em', fontWeight: 700, color: '#626262' }}>
              Featured
            </div>
            <div className="max-w-[1200px] mx-auto px-2 md:px-4 text-center pt-8 md:pt-16 w-full">
          <h1 style={{ fontFamily: '"Quicksand", Sans-serif', fontSize: '1.2em', fontWeight: 600, color: '#37A65E' }}>
            Blogs
          </h1>
          <p className="[font-family:'Quicksand',Sans-serif] text-gray-600 text-sm md:text-lg">
            Latest Insights, Trends and Career Advice from Career141
          </p>
          <a href="/blogs/executive-search-what-really-is-it/" className="block">
            <div className="mx-auto mt-6 md:mt-8 bg-white rounded-[30px] md:rounded-[50px] border border-gray-300 flex flex-col md:flex-row items-stretch justify-between max-w-4xl overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
              <div className="text-left p-4 md:p-6 w-full md:w-1/2 flex flex-col justify-center">
                <p className="[font-family:'Quicksand',Sans-serif] text-[#531590] text-xs md:text-sm font-bold mb-2">Blog</p>
                <p style={{ fontFamily: '"Quicksand", Sans-serif', fontSize: '1.2em', lineHeight: '1.3em', color: '#626262', fontWeight: 700 }}>Executive Search - What really is it?</p>
              </div>
