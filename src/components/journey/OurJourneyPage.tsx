...
export function OurJourneyPage() {
  return (
    <main className="flex flex-col items-start relative bg-white w-full min-h-screen">
      ...
      <a
        href="https://api.whatsapp.com/send?phone=94777141141"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed right-5 bottom-5 md:right-10 md:bottom-10 z-50 shadow-[0px_0px_11px_0px_rgba(0,0,0,0.5)] rounded-[34px] bg-[#25d366] p-[10px] md:p-[14px] hover:scale-110 transition-transform"
