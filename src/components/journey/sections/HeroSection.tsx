...
export function HeroSection() {
  return (
    <section className="relative flex flex-col w-full items-center gap-5 z-10 -mt-16 md:-mt-24 lg:-mt-32">
      ...
      <div
        className="absolute w-full h-[calc(100%+400px)] -top-[350px] left-0 pointer-events-none z-[-1000]"
        style={{
      ...
      <div className="flex flex-col items-center gap-5 pt-16 md:pt-32 lg:pt-[200px] pb-4 lg:pb-[15.2px] px-6 md:px-10 lg:px-[106.45px] w-full relative z-10">
